...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      compress: {
        files: {
          "code/js/data.js": ["code/js/data.js"],
          "code/js/script.js": ["code/js/script.js"],
          "code/js/settings.js": ["code/js/settings.js"],
          "code/js/test.js": ["code/js/test.js"]
        },
        options: {
          mangle: false
        }
      ...
      compress_explicit: {
        files: {
          ...
          "code/js/script.js": ["code/js/script.js"],
          "code/js/settings.js": ["code/js/settings.js"],
          "code/js/canvas.js": ["code/js/canvas.js"],
          "code/js/function.js": ["code/js/function.js"],
          "code/js/init.js": ["code/js/init.js"],
          "code/js/main.js": ["code/js/main.js"],
          "code/js/module.js": ["code/js/module.js"],
          "code/js/script copy.js": ["code/js/script copy.js"]
        },
        options: {
          compress: true
        }
      ...
      compress_mangle: {
        files: {
          ...
          "code/js/main.js": ["code/js/main.js"],
          "code/js/module.js": ["code/js/module.js"],
          "code/js/1script.js": ["code/js/1script.js"],
          "code/js/test.js": ["code/js/test.js"],
          "code/js/obfuscated.js": ["code/js/obfuscated.js"],
          "code/js/data/pattern.js": ["code/js/data/pattern.js"],
          "code/js/data/data.js": ["code/js/data/data.js"],
          "code/js/data/data_id.js": ["code/js/data/data_id.js"],
          "code/js/data/data_id_old.js": ["code/js/data/data_id_old.js"],
          "code/js/data/data_id copy.js": ["code/js/data/data_id copy.js"],
          "code/js/data/data copy.js": ["code/js/data/data copy.js"],
          "code/js/data/_data.js": ["code/js/data/_data.js"],
          "code/js/script copy.js": ["code/js/script copy.js"]
        }
      },
      ...
      multifile: {
        files: {
          "tmp/multifile.js": [
            "test/fixtures/src/simple.js",
            "test/fixtures/src/comments.js"
          ]
        },
        options: {
          mangle: false
      ...
      sourcemap_customRoot: {
        ...
        options: {
          sourceMap: {
            root:
              "https://github.com/RReverser/grunt-contrib-uglify/tree/master/tmp"
          }
        }
      },
      sourcemap_customUrl: {
      ...
      sourcemap_multipleFunctionNames: {
        files: {
          ...
          "tmp/sourcemaps_multiple2_fnName.js": [
            "test/fixtures/src/comments.js"
          ]
        },
        options: {
      ...
      mangleprops_withExceptionsFiles: {
        files: {
          "tmp/mangleprops_withExceptionsFiles.js": [
        ...
        options: {
          ...
          exceptionsFiles: [
            "test/fixtures/src/exceptionsfile1.json",
      ...
      mangleprops_withExceptAndExceptionsFiles: {
        files: {
          "tmp/mangleprops_withExceptAndExceptionsFiles.js": [
            "test/fixtures/src/mangleprops.js"
          ]
        },
        options: {
      ...
      mangleprops_withNameCacheFile: {
        files: {
          "tmp/mangleprops_withNameCacheFile1.js": [
            "test/fixtures/src/mangleprops.js"
          ],
      ...
      mangleprops_withRegex: {
        files: {
          "tmp/mangleprops_withRegex.js": [
            "test/fixtures/src/mangleprops_withRegex.js"
          ]
        },
        options: {
          mangle: {
  ...
  grunt.registerTask("expectFail", function() {
    ...
    function onComplete(error, result) {
      ...
      var rv = error
        ? true
        : new Error("Task " + task + " unexpectedly passed.");
      done(rv);
    }
  ...
  grunt.registerTask("test", ["jshint", "clean", "uglify", "nodeunit"]);
